    ...
    <div className="w-full h-auto overflow-x-hidden">
      <div className='w-screen h-[500px] relative'>
        ...
        <div className='absolute w-fit left-0 right-0 mx-auto flex gap-8 bottom-44'>
            <div  onClick={prevSlide} className='w-14 h-12 border-[1px] border-gray-700 hover:text-white hover:font-bold hover:bg-gray-400 active:bg-gray-900 duration-100'>
                <HiArrowLeft className='ml-4 mt-3.5'/>
            </div>
            <div onClick={nextSlide} className='w-14 h-12 border-[1px] border-gray-700 hover:text-white hover:font-bold hover:bg-gray-400 active:bg-gray-900 duration-100'>
                <HiArrowRight className='ml-5 mt-3.5'/>
            </div>
        </div>
      </div>
    </div>
