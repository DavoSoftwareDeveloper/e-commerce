    ...
    <div className="group relative">
      ...
      <div className="w-full border-[1px] px-2 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2 relative overflow-hidden text-sm w-24">
            <div className="relative w-28 flex gap-2 transform group-hover:translate-x-24
            ...
            flex items-center gap-1 top-0 transform -translate-x-24 group-hover:translate-x-0
